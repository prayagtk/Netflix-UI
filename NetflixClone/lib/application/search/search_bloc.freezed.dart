...
mixin _$SearchState {
  List<SearchResultData> get searchResultList =>
      throw _privateConstructorUsedError;
  List<Downloads> get ideLisst => throw _privateConstructorUsedError;
  bool get isLodinng => throw _privateConstructorUsedError;
...
class _$SearchStateCopyWithImpl<$Res> implements $SearchStateCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? ideLisst = freezed,
    Object? isLodinng = freezed,
    ...
    return _then(_value.copyWith(
      ...
      ideLisst: ideLisst == freezed
          ? _value.ideLisst
          : ideLisst // ignore: cast_nullable_to_non_nullable
              as List<Downloads>,
      isLodinng: isLodinng == freezed
          ? _value.isLodinng
          : isLodinng // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$_SearchState implements _SearchState {
  const _$_SearchState(
      ...
      required final List<Downloads> ideLisst,
      required this.isLodinng,
  ...
  final List<Downloads> _ideLisst;
  @override
  List<Downloads> get ideLisst {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_ideLisst);
  }

  @override
  final bool isLodinng;
  @override
  final bool isError;

  @override
  String toString() {
    return 'SearchState(searchResultList: $searchResultList, ideLisst: $ideLisst, isLodinng: $isLodinng, isError: $isError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._ideLisst, _ideLisst) &&
            const DeepCollectionEquality().equals(other.isLodinng, isLodinng) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_ideLisst),
      const DeepCollectionEquality().hash(isLodinng),
